...
export function round(out, a) {
  out[0] = math.glm.round(a[0]);
  out[1] = math.glm.round(a[1]);
  out[2] = math.glm.round(a[2]);
  out[3] = math.glm.round(a[3]);
  return out;
}
...
export function random(out, scale) {
  ...
  var s1, s2;
  do {
    v1 = math.glm.RANDOM() * 2 - 1;
    v2 = math.glm.RANDOM() * 2 - 1;
    s1 = v1 * v1 + v2 * v2;
  } while (s1 >= 1);
  do {
    v3 = math.glm.RANDOM() * 2 - 1;
    v4 = math.glm.RANDOM() * 2 - 1;
    s2 = v3 * v3 + v4 * v4;
  } while (s2 >= 1);
